...
assert.match(page,/styles\.css\?v=21\.5\.4/,'Elite page must load fresh styles');
assert.match(sw,/sporty-codes-v21\.5\.4/,'PWA cache must be bumped');
console.log('v21.5.4 persistent Elite navigation checks passed');
