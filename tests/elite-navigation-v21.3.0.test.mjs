...
assert.match(page,/styles\.css\?v=21\.7\.2/,'Elite page must load fresh styles');
assert.match(sw,/sporty-codes-v21\.7\.2/,'PWA cache must be bumped');
console.log('v21.7.2 persistent Elite navigation checks passed');
