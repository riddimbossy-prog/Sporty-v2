...
assert.match(page,/styles\.css\?v=21\.4\.0/,'Elite page must load fresh styles');
assert.match(sw,/sporty-codes-v21\.4\.0/,'PWA cache must be bumped');
console.log('v21.4.0 persistent Elite navigation checks passed');
