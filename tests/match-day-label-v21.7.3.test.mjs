...
const expectedDynamicTomorrow = __test.coerceKickoff('Tomorrow 20:00')?.toISOString();
...
assert.equal(tips[0].kickoff,expectedDynamicTomorrow);
...
console.log('match-day labels v21.7.3 test passed');
