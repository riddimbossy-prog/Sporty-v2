...
assert.equal(read('VERSION').trim(),'21.6.1','version should be 21.6.1');
...
assert.match(index,/src\/region\.js\?v=21\.6\.1/,'Ghana home should load the shared region controller');
