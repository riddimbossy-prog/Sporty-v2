...
assert.equal(read('VERSION').trim(),'21.3.0','version should be 21.3.0');
...
assert.match(index,/src\/region\.js\?v=21\.3\.0/,'Ghana home should load the shared region controller');
