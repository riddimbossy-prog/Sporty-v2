...
assert.equal(read('VERSION').trim(),'21.7.3','version should be 21.7.3');
...
assert.match(index,/src\/region\.js\?v=21\.7\.3/,'Ghana home should load the shared region controller');
