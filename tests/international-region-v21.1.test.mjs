...
assert.equal(read('VERSION').trim(),'21.4.0','version should be 21.4.0');
...
assert.match(index,/src\/region\.js\?v=21\.4\.0/,'Ghana home should load the shared region controller');
