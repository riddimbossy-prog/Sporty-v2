...
assert.equal(read('VERSION').trim(),'21.4.1','version should be 21.4.1');
...
assert.match(index,/src\/region\.js\?v=21\.4\.1/,'Ghana home should load the shared region controller');
