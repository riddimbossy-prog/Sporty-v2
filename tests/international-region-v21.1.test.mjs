...
assert.equal(read('VERSION').trim(),'21.5.1','version should be 21.5.1');
...
assert.match(index,/src\/region\.js\?v=21\.5\.1/,'Ghana home should load the shared region controller');
