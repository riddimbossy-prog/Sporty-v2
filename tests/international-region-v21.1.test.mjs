...
assert.equal(read('VERSION').trim(),'21.7.2','version should be 21.7.2');
...
assert.match(index,/src\/region\.js\?v=21\.7\.2/,'Ghana home should load the shared region controller');
